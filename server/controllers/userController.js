...
export class UserController {
  ...
  static async registration( {username, password, age, email, company, id, gender, name}) {
    try {
      const data =  await  con.query('INSERT INTO "users" (username, password, age, email, company, id,gender,name)'
          + ' VALUES ($1 ,$2 ,$3, $4 ,$5,$6,$7,$8)',
          [username, password, age, email, company, id, gender, name]);

      return {username,  age, email, company, id, gender, name}
    } catch (e) {
      throw new Error(e);
    }
  }
